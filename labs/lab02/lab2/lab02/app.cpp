#include <iostream>
#include <string.h>					// Can't use strcpy in printMsg() w/o including header
using namespace std;
...
double getAvg();
char determineGrade(double);	// Prototype not spelled the same way as declaration and definition, changed to correct spelling
